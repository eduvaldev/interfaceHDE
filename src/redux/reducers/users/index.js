const initialState = {
  ...
  const usersReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case "GET_CUSTOMERS":
          return { ...state, customers: action.data.data.customers, bodyarea: action.data.data.bodyarea }
        case "GET_PROFILE":
          return { ...state, profile: action.data, note: action.note}
        case "GET_NOTES":
          return { ...state, user_notes: action.data}
        case "GET_SESSIONS_ALL_DATA":
          return {
            ...state,
            allData: action.data,
